...
export function AuthNavigator() {
  ...
  useEffect(() => () => clearPendingIntent(), [clearPendingIntent]);

  return (
    <Stack.Navigator
      key={invalidation ? "invalidated" : "auth"}
      initialRouteName={invalidation ? ROUTES.SESSION_INVALIDATED : ROUTES.LOGIN}
    ...
    >
      ...
      <Stack.Screen name={ROUTES.AUTH_PROFILE} component={AuthProfileScreen} options={{ gestureEnabled: false }} />
